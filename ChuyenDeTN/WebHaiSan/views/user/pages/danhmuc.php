...
<?php
	...
	$sql_cate = mysqli_query($connect,"SELECT * FROM tbl_category,tbl_product WHERE tbl_category.category_id = tbl_product.category_id AND tbl_product.category_id='$id' ORDER BY tbl_product.sanpham_id DESC");	
	
	$sql_category = mysqli_query($connect,"SELECT * FROM tbl_category,tbl_product WHERE tbl_category.category_id = tbl_product.category_id AND tbl_product.category_id='$id' ORDER BY tbl_product.sanpham_id DESC");		
									...
									<div class="col-md-4 product-men mt-5">
										<div class="men-pro-item simpleCart_shelfItem">
											<div class="men-thumb-item text-center">
												<img src="./uploads/<?php echo $row_sanpham['sanpham_image'] ?>" alt="" height="370" width="250">
											...
											<div class="item-info-product text-center border-top mt-4">
												...
												<div class="info-product-price my-2">
													<span class="item_price"><?php echo number_format($row_sanpham['sanpham_giakm']).'vnđ' ?>/ 1Kg</span>
												...
												<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
													<form action="?quanly=giohang" method="post">
														<fieldset>
															...
															<input type="submit" name="themgiohang" value="Thêm giỏ hàng" class="btn btn-primary" />
														</fieldset>	
													</form>
												</div>
											</div>
